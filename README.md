...
```
cd existing_repo
git remote add origin https://git.uwaterloo.ca/m49ye/team-102-5.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.uwaterloo.ca/m49ye/team-102-5/-/settings/integrations)
