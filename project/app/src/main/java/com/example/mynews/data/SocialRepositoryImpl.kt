        ...
        try {
            for (friendId in friendIDs) {
                firestore.collection("reactions")
                    ...
                    .addSnapshotListener { snapshot, error ->
                        if (error != null) {
                            Log.e("getFriendsReactions", "Error fetching reactions: ${error.message}", error)
                            return@addSnapshotListener
                        }
                        ...
                        if (snapshot != null) {
                            val updatedReactions = snapshot.documents.mapNotNull { document ->
                                ...
                                val articleData = document.get("article") as? Map<*, *> ?: return@mapNotNull null
                                val sourceData = articleData["source"] as? Map<*, *> ?: return@mapNotNull null
                                ...
                                val reaction = document.getString("reaction") ?: return@mapNotNull null
